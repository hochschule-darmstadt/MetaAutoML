...
class AdapterServiceServicer(Adapter_pb2_grpc.AdapterServiceServicer):
    ...
    def zip_script(self):
        ...
        if in_cluster():
            ...
            shutil.move(f"{export_zip_file_name}.zip", "omaml/output/autopytorch-export.zip")
            ...
            outputJson.update({"file_location": os.path.join(BASE_DIR, "MetaAutoML-Adapter-AutoPytorch")})
        return outputJson
