...
class ControllerService(ControllerServiceBase):
    ...
    async def delete_dataset(
        ...
        """delete a specific dataset and every related object"""
        request = self._controllerManager.DeleteDataset(delete_dataset_request)
        return request

    async def delete_training(
        self, delete_training_request: "DeleteTrainingRequest"
    ) -> "DeleteTrainingResponse":
        """delete a specific training and every related object"""
        request = self._controllerManager.DeleteTraining(delete_training_request)
        return request

    async def delete_model(
        self, delete_model_request: "DeleteModelRequest"
    ) -> "DeleteModelResponse":
        """delete a specific model and every related object"""
        request = self._controllerManager.DeleteModel(delete_model_request)
        return request

    async def create_new_user(self, create_new_user_request: "CreateNewUserRequest") -> "CreateNewUserResponse":
    ...
    async def get_compatible_auto_ml_solutions(
        self, get_compatible_auto_ml_solutions_request: "GetCompatibleAutoMlSolutionsRequest"
    ...
    async def get_available_strategies(
        ...
        response = self._controllerManager.GetAvailableStrategies(get_available_strategies_request)
        return response

    async def get_dataset_types(self, get_dataset_types_request: "GetDatasetTypesRequest") -> "GetDatasetTypesResponse":
    ...
    async def get_dataset(self, get_dataset_request: "GetDatasetRequest") -> "GetDatasetResponse":
        """
    ...
    async def get_trainings(self, get_trainings_request: "GetTrainingsRequest") -> "GetTrainingsResponse":
    ...
    async def get_training(self, get_training_request: "GetTrainingRequest") -> "GetTrainingResponse":
    ...
    async def get_all_trainings(self, get_all_trainings_request: "GetAllTrainingsRequest") -> "GetAllTrainingsResponse":
    ...
    async def get_tabular_dataset_column(
        ...
        response = self._controllerManager.GetTabularDatasetColumn(get_tabular_dataset_column_request)
        return response
    ...
    async def get_model(self, get_model_request: "GetModelRequest") -> "GetModelResponse":
    ...
    async def get_objects_information(
        ...
        response = self._controllerManager.GetObjectsInformation(get_objects_information_request)
        return response
