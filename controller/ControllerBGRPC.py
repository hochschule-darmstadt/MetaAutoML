...
# sources: ControllerService.proto, DatasetRelatedMessages.proto, Enumerations.proto, ModelRelatedMessages.proto, OntologyRelatedMessages.proto, PredictionDatasetRelatedMessages.proto, TrainingRelatedMessages.proto, UserRelatedMessages.proto
...
@dataclass(eq=False, repr=False)
class GetPredictionDatasetRequest(betterproto.Message):
    user_identifier: str = betterproto.string_field(1)
    prediction_dataset_identifier: str = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class GetPredictionDatasetResponse(betterproto.Message):
    prediction_dataset: "PredictionDataset" = betterproto.message_field(1)


@dataclass(eq=False, repr=False)
class GetPredictionDatasetsRequest(betterproto.Message):
    user_identifier: str = betterproto.string_field(1)
    dataset_identifier: str = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class GetPredictionDatasetsResponse(betterproto.Message):
    prediction_datasets: List["PredictionDataset"] = betterproto.message_field(1)


@dataclass(eq=False, repr=False)
class DeletePredictionDatasetRequest(betterproto.Message):
    user_identifier: str = betterproto.string_field(1)
    prediction_dataset_identifier: str = betterproto.string_field(2)


@dataclass(eq=False, repr=False)
class DeletePredictionDatasetResponse(betterproto.Message):
    pass


@dataclass(eq=False, repr=False)
class PredictionDataset(betterproto.Message):
    identifier: str = betterproto.string_field(1)
    name: str = betterproto.string_field(2)
    type: str = betterproto.string_field(3)
    creation_date: datetime = betterproto.message_field(4)
...
@dataclass(eq=False, repr=False)
class CreatePredictionDatasetRequest(betterproto.Message):
    user_identifier: str = betterproto.string_field(1)
    file_name: str = betterproto.string_field(2)
    prediction_dataset_name: str = betterproto.string_field(3)
    dataset_identifier: str = betterproto.string_field(4)


@dataclass(eq=False, repr=False)
class CreatePredictionDatasetResponse(betterproto.Message):
    pass
...
class DeleteModelRequest(betterproto.Message):
    user_identifier: str = betterproto.string_field(1)
    model_identifier: str = betterproto.string_field(2)
...
class Model(betterproto.Message):
    identifier: str = betterproto.string_field(1)
    training_identifier: str = betterproto.string_field(2)
    ...
    dataset_identifier: str = betterproto.string_field(11)
...
class ModelPredictRequest(betterproto.Message):
    user_identifier: str = betterproto.string_field(1)
    prediction_dataset_identifier: str = betterproto.string_field(2)
    model_identifier: str = betterproto.string_field(3)


@dataclass(eq=False, repr=False)
class ModelPredictResponse(betterproto.Message):
    model_prediction_identifier: str = betterproto.string_field(1)
...
class CreateTrainingResponse(betterproto.Message):
    training_identifier: str = betterproto.string_field(1)
...
class GetObjectsInformationRequest(betterproto.Message):
    identifiers: List[str] = betterproto.string_field(1)
...
class ControllerServiceStub(betterproto.ServiceStub):
    ...
    async def create_prediction_dataset(
        self,
        create_prediction_dataset_request: "CreatePredictionDatasetRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/ControllerService/CreatePredictionDataset",
            create_prediction_dataset_request,
            CreatePredictionDatasetResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_prediction_datasets(
        self,
        get_prediction_datasets_request: "GetPredictionDatasetsRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/ControllerService/GetPredictionDatasets",
            get_prediction_datasets_request,
            GetPredictionDatasetsResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_prediction_dataset(
        self,
        get_prediction_dataset_request: "GetPredictionDatasetRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/ControllerService/GetPredictionDataset",
            get_prediction_dataset_request,
            GetPredictionDatasetResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def delete_prediction_dataset(
        self,
        delete_prediction_dataset_request: "DeletePredictionDatasetRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/ControllerService/DeletePredictionDataset",
            delete_prediction_dataset_request,
            DeletePredictionDatasetResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
...
class ControllerServiceBase(ServiceBase):
    ...
    async def __rpc_create_prediction_dataset(
        self,
        stream: "grpclib.server.Stream[CreatePredictionDatasetRequest, CreatePredictionDatasetResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.create_prediction_dataset(request)
        await stream.send_message(response)

    async def __rpc_get_prediction_datasets(
        self,
        stream: "grpclib.server.Stream[GetPredictionDatasetsRequest, GetPredictionDatasetsResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_prediction_datasets(request)
        await stream.send_message(response)

    async def __rpc_get_prediction_dataset(
        self,
        stream: "grpclib.server.Stream[GetPredictionDatasetRequest, GetPredictionDatasetResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_prediction_dataset(request)
        await stream.send_message(response)

    async def __rpc_delete_prediction_dataset(
        self,
        stream: "grpclib.server.Stream[DeletePredictionDatasetRequest, DeletePredictionDatasetResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.delete_prediction_dataset(request)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/ControllerService/CreatePredictionDataset": grpclib.const.Handler(
                self.__rpc_create_prediction_dataset,
                grpclib.const.Cardinality.UNARY_UNARY,
                CreatePredictionDatasetRequest,
                CreatePredictionDatasetResponse,
            ),
            "/ControllerService/GetPredictionDatasets": grpclib.const.Handler(
                self.__rpc_get_prediction_datasets,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetPredictionDatasetsRequest,
                GetPredictionDatasetsResponse,
            ),
            "/ControllerService/GetPredictionDataset": grpclib.const.Handler(
                self.__rpc_get_prediction_dataset,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetPredictionDatasetRequest,
                GetPredictionDatasetResponse,
            ),
            "/ControllerService/DeletePredictionDataset": grpclib.const.Handler(
                self.__rpc_delete_prediction_dataset,
                grpclib.const.Cardinality.UNARY_UNARY,
                DeletePredictionDatasetRequest,
                DeletePredictionDatasetResponse,
            ),
        }
