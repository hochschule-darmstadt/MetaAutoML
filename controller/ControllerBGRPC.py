...
class SetDatasetConfigurationRequest(betterproto.Message):
    ...
    column_configuration: Dict[str, "ColumnConfiguration"] = betterproto.map_field(
        4, betterproto.TYPE_STRING, betterproto.TYPE_MESSAGE
    )
    """
    Dictonary of the dataset column configuration{"PassengerId":
    {"datatype_selected": ":string","role_selected": ":index"},}
    """
...
@dataclass(eq=False, repr=False)
class ColumnConfiguration(betterproto.Message):
    datatype_selected: str = betterproto.string_field(1)
    """The dataset type IRI selected by the user":categorical"""

    role_selected: str = betterproto.string_field(2)
...
class TableColumn(betterproto.Message):
    ...
    """The column name defined in the datasetexample: "Survived"""

    type: "DataType" = betterproto.enum_field(2)
    """
    The dataset type asigned by OMA-MLexample: DATATYPE_BOOLEAN#TODO Change to
    ontology IRIs or is this even still required?
    """

    convertible_types: List["DataType"] = betterproto.enum_field(3)
    """
    List of dataset types that this column can be converted toexample:
    [DATATYPE_CATEGORY, DATATYPE_INT]#TODO Change to ontology IRIs or is this
    even still required?
    """
...
class GetTabularDatasetColumnResponse(betterproto.Message):
    ...
    """
    List of TableColumn objects (see TableColumn for more details)example:
