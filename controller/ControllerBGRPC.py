...
# sources: ChatbotRelatedMessages.proto, ControllerService.proto, DatasetRelatedMessages.proto, Enumerations.proto, ModelRelatedMessages.proto, OntologyRelatedMessages.proto, PredictionRelatedMessages.proto, TrainingRelatedMessages.proto, UserRelatedMessages.proto
...
@dataclass(eq=False, repr=False)
class GetTrainingsMetadataRequest(betterproto.Message):
    user_id: str = betterproto.string_field(1)
    """
    Unique user id generated by the controller on the create new user request
    from the frontend. Linked to a AspNetUser saved within the MS Sql database
...
@dataclass(eq=False, repr=False)
class GetTrainingsMetadataResponse(betterproto.Message):
    trainings: List["TrainingMetadata"] = betterproto.message_field(1)
    """
    List of TrainingMetadata records from MongoDB (see TrainingMetadata for
    more detals)example: [TrainingMetadata, TrainingMetadata]
    """

    pagination_metadata: "PaginationMetadata" = betterproto.message_field(2)
    """Pagination metadataexample: PaginationMetadata"""


@dataclass(eq=False, repr=False)
class GetTrainingMetadataRequest(betterproto.Message):
    user_id: str = betterproto.string_field(1)
    """
    Unique user id generated by the controller on the create new user request
    from the frontend. Linked to a AspNetUser saved within the MS Sql database
...
@dataclass(eq=False, repr=False)
class GetTrainingMetadataResponse(betterproto.Message):
    training: "TrainingMetadata" = betterproto.message_field(1)
    """
    TrainingMetadata record from MongoDB (see TrainingMetadata for more
    detals)example: TrainingMetadata
    """
...
@dataclass(eq=False, repr=False)
class GetSuggestedTrainingRuntimeRequest(betterproto.Message):
    user_id: str = betterproto.string_field(1)
    """
    Unique user id generated by the controller on the create new user request
    from the frontend. Linked to a AspNetUser saved within the MS Sql database
...
class GetSuggestedTrainingRuntimeResponse(betterproto.Message):
    suggested_runtime: int = betterproto.int32_field(1)
    """The suggested runtime for this da"""


@dataclass(eq=False, repr=False)
class PaginationMetadata(betterproto.Message):
    total_items: int = betterproto.int32_field(1)
    """
    The total number of items availableexample: 50 //total 50 items available
    """

    page_number: int = betterproto.int32_field(2)
    """The current page numberexample: 2 //current page number is 2"""
    ...
    """
    The total number of pages availableexample: 5 //total 5 pages available
    """
...
class ControllerServiceStub(betterproto.ServiceStub):
    ...
    async def get_trainings_metadata(
        self,
        get_trainings_metadata_request: "GetTrainingsMetadataRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/ControllerService/GetTrainingsMetadata",
            get_trainings_metadata_request,
            GetTrainingsMetadataResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_training_metadata(
        self,
        get_training_metadata_request: "GetTrainingMetadataRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/ControllerService/GetTrainingMetadata",
            get_training_metadata_request,
            GetTrainingMetadataResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
    ...
    async def get_suggested_training_runtime(
        self,
        get_suggested_training_runtime_request: "GetSuggestedTrainingRuntimeRequest",
        *,
        timeout: Optional[float] = None,
        deadline: Optional["Deadline"] = None,
        metadata: Optional["MetadataLike"] = None
        ...
        return await self._unary_unary(
            "/ControllerService/GetSuggestedTrainingRuntime",
            get_suggested_training_runtime_request,
            GetSuggestedTrainingRuntimeResponse,
            timeout=timeout,
            deadline=deadline,
            metadata=metadata,
...
class ControllerServiceBase(ServiceBase):
    ...
    async def __rpc_get_trainings_metadata(
        self,
        stream: "grpclib.server.Stream[GetTrainingsMetadataRequest, GetTrainingsMetadataResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_trainings_metadata(request)
        await stream.send_message(response)

    async def __rpc_get_training_metadata(
        self,
        stream: "grpclib.server.Stream[GetTrainingMetadataRequest, GetTrainingMetadataResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_training_metadata(request)
        await stream.send_message(response)
    ...
    async def __rpc_get_suggested_training_runtime(
        self,
        stream: "grpclib.server.Stream[GetSuggestedTrainingRuntimeRequest, GetSuggestedTrainingRuntimeResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.get_suggested_training_runtime(request)
        await stream.send_message(response)
    ...
    async def __rpc_start_explainer_dashboard(
        self,
        stream: "grpclib.server.Stream[StartDashboardRequest, StartDashboardResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    async def __rpc_stop_explainer_dashboard(
        self,
        stream: "grpclib.server.Stream[StopDashboardRequest, StopDashboardResponse]",
    ) -> None:
        request = await stream.recv_message()
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/ControllerService/GetTrainingsMetadata": grpclib.const.Handler(
                self.__rpc_get_trainings_metadata,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTrainingsMetadataRequest,
                GetTrainingsMetadataResponse,
            ),
            "/ControllerService/GetTrainingMetadata": grpclib.const.Handler(
                self.__rpc_get_training_metadata,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetTrainingMetadataRequest,
                GetTrainingMetadataResponse,
            ),
            ...
            "/ControllerService/GetSuggestedTrainingRuntime": grpclib.const.Handler(
                self.__rpc_get_suggested_training_runtime,
                grpclib.const.Cardinality.UNARY_UNARY,
                GetSuggestedTrainingRuntimeRequest,
                GetSuggestedTrainingRuntimeResponse,
            ),
            ...
            "/ControllerService/StopExplainerDashboard": grpclib.const.Handler(
                self.__rpc_stop_explainer_dashboard,
                grpclib.const.Cardinality.UNARY_UNARY,
                StopDashboardRequest,
                StopDashboardResponse,
            ),
