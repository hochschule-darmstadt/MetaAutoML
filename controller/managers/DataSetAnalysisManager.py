...
class DataSetAnalysisManager:
    ...
    def __make_feature_imbalance_plot(self, first_colname, second_colname, correlation_value, plot_path):
        ...
        plt.title(f"Correlation plot of [{first_colname}, {second_colname}]")
        ...
        return {"type": "feature_imbalance_plot",
                ...
                "description": f"This plot shows the {len(x_data)} most common combinations of the columns "
                               f"{first_colname} and {second_colname} ordered by their frequency. These two columns "
                               f"have a correlation value of {round(correlation_value, 2)}.",
                "path": filename}
