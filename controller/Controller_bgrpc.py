...
class TestAutoMlRequest(betterproto.Message):
    ...
    auto_ml_name: str = betterproto.string_field(3)
...
class GetAutoMlModelRequest(betterproto.Message):
    ...
    auto_ml: str = betterproto.string_field(2)
...
class GetDatasetsRequest(betterproto.Message):
    type: "DatasetType" = betterproto.enum_field(1)
...
class StartAutoMlProcessRequest(betterproto.Message):
    ...
    task: "MachineLearningTask" = betterproto.enum_field(2)
    tabular_config: "AutoMlConfigurationTabularData" = betterproto.message_field(3)
    required_auto_mls: List[str] = betterproto.string_field(4)
    runtime_constraints: "AutoMlRuntimeConstraints" = betterproto.message_field(5)
    file_configuration: Dict[str, str] = betterproto.map_field(
        6, betterproto.TYPE_STRING, betterproto.TYPE_STRING
    )
    test_config: "TestConfiguration" = betterproto.message_field(7)
    metric: str = betterproto.string_field(8)
