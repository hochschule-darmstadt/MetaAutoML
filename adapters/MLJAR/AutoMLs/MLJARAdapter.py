...
class MLJARAdapter:
    ...
    def __tabular_classification(self):
        ...
        parameters = translate_parameters(":mljar", self._configuration["configuration"]["task"], self._configuration["configuration"].get('parameters', {}), mjpc.parameters)
        automl = AutoML(total_time_limit=self._configuration["configuration"]["runtime_limit"] * 60, mode="Perform", **parameters, results_path=result_path, explain_level=0)
        automl.fit(X, y)
