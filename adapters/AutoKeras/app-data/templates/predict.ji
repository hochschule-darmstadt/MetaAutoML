...
from predict_time_sources import feature_preparation, DataType, SplitMethod, encode_category_columns
...
if __name__ == '__main__':
    ...
    if config_json["configuration"]["task"] in [":tabular_classification", ":tabular_regression", ":text_classification", ":text_regression", ":time_series"]:
        ...
        X = encode_category_columns(X, config_json["dataset_configuration"])
