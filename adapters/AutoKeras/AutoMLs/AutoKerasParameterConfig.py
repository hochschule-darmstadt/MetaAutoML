...
autokeras_objectives = {
    ...
    ":true_negatives": keras_tuner.Objective("true_negatives", direction="max"),
    ":false_positives": keras_tuner.Objective("false_positives", direction="min"),
    ":false_negatives": keras_tuner.Objective("false_negatives", direction="min"),
