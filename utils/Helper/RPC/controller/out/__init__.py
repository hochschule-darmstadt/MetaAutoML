...
# sources: ControllerService.proto, DatasetRelatedMessages.proto, Enumerations.proto, Miscellaneous.proto, ModelRelatedMessages.proto, TrainingRelatedMessages.proto, WizzardMessages.proto
...
class GetModelsRequest(betterproto.Message):
    user_identifier: str = betterproto.string_field(1)
    dataset_identifer: str = betterproto.string_field(2)
...
class ModelPredictRequest(betterproto.Message):
    ...
    model_idenfier: str = betterproto.string_field(3)
...
@dataclass(eq=False, repr=False)
class StartTrainingRequest(betterproto.Message):
    user_identifier: str = betterproto.string_field(1)
    dataset_identifier: str = betterproto.string_field(2)
...
@dataclass(eq=False, repr=False)
class StartTrainingResponse(betterproto.Message):
...
class ControllerServiceStub(betterproto.ServiceStub):
    ...
    async def start_training(
        ...
        *,
        ...
        return await self._unary_unary(
            "/ControllerService/StartTraining",
...
class ControllerServiceBase(ServiceBase):
    ...
    async def start_training(
        self, start_training_request: "StartTrainingRequest"
    ) -> "StartTrainingResponse":
        raise grpclib.GRPCError(grpclib.const.Status.UNIMPLEMENTED)
    ...
    async def __rpc_start_training(
        self,
        stream: "grpclib.server.Stream[StartTrainingRequest, StartTrainingResponse]",
    ) -> None:
        request = await stream.recv_message()
        response = await self.start_training(request)
        await stream.send_message(response)
    ...
    def __mapping__(self) -> Dict[str, grpclib.const.Handler]:
        return {
            ...
            "/ControllerService/StartTraining": grpclib.const.Handler(
                self.__rpc_start_training,
                grpclib.const.Cardinality.UNARY_UNARY,
