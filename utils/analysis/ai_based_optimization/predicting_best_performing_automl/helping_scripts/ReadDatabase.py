...
def readDatabase(trainings: collection ,datasets: collection, models: collection,file_path: str, measure_classification: str, measure_regression: str):
    ...
    for training in trainings.find():
        ...
        if "runtime_limit" in training["configuration"]:
            ...
            if dataset_name in ["airlines.csv", "KDDCup09_appetency.csv", "electricity.csv", "bank-marketing.csv", "Amazon_employee_access.csv", "eeg-eye-state.csv", "jm1.csv", "SpeedDating.csv", "mushroom.csv", "christine.csv", "phoneme.csv", "Bioresponse.csv", "kr-vs-kp.csv", "kc1.csv", "pc4.csv", "profb.csv", "credit-approval.csv", "breast-w.csv", "jannis.csv", "shuttle.csv", "tamilnadu-electricity.csv", "letter.csv", "gas-drift.csv", "har.csv", "artificial-characters.csv", "optdigits.csv", "waveform-5000.csv", "splice.csv", "car.csv", "one-hundred-plants-margin.csv", "vehicle.csv", "eucalyptus.csv", "soybean.csv", "LED-display-domain-7digit.csv"]:
            #if dataset_name in ["airlines.csv", "albert.csv", "KDDCup09_appetency.csv", "electricity.csv", "bank-marketing.csv", "Amazon_employee_access.csv", "riccardo.csv", "eeg-eye-state.csv", "jm1.csv", "SpeedDating.csv", "mushroom.csv", "christine.csv", "phoneme.csv", "Bioresponse.csv", "kr-vs-kp.csv", "kc1.csv", "pc4.csv", "profb.csv", "credit-approval.csv", "breast-w.csv", "covertype.csv", "dionis.csv", "Devnagari-Script.csv", "jannis.csv", "Fashion-MNIST.csv", "shuttle.csv", "tamilnadu-electricity.csv", "letter.csv", "gas-drift.csv", "har.csv", "artificial-characters.csv", "optdigits.csv", "waveform-5000.csv", "splice.csv", "car.csv", "one-hundred-plants-margin.csv", "vehicle.csv", "eucalyptus.csv", "soybean.csv", "LED-display-domain-7digit.csv"]:
